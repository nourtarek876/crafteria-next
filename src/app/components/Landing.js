        ...
        <div className="card-main">
          <div className="cards">
            ...
            <div className="secound-card">
              <div className="card1">
                <div className="card-image"></div>
               <FadeInCenterComponent> <p className="card-title">Kaled Amr (Pottery)</p>
                <p className="card-body">
                  Nullam ac tristique nulla, at convallis quam. Integer
                  consectetur mi nec magna tristique, non lobortis.
                </p></FadeInCenterComponent>
            ...
            <div className="third-card">
              <div className="card1">
                <div className="card-image"></div>
               <FadeInCenterComponent><p className="card-title">Omar Ahmed (Copper)</p>
                <p className="card-body">
                  Nullam ac tristique nulla, at convallis quam. Integer
                  consectetur mi nec magna tristique, non lobortis.
                </p></FadeInCenterComponent> 
